...
jsonRadio.addEventListener("click", () => {
    let requestJsonBox = document.getElementById("requestJsonBox").style.display = "block";
    let parametersBox = document.getElementById("parametersBox").style.display = "none";
})

// If the user clicks on params box, hide the json box
let paramsRadio = document.getElementById("paramsRadio");
paramsRadio.addEventListener("click", () => {
    let requestJsonBox = document.getElementById("requestJsonBox").style.display = "none";
    let parametersBox = document.getElementById("parametersBox").style.display = "block";
})
...
addParam.addEventListener("click", () => {
    ...
    let getparam = getparameter(string);
    params.appendChild(getparam)
